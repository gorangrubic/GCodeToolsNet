...
$(function () {
	...
	$('#save_btn').click(function () {
		...
		// put all the lines back together in the bestPath order
		var fout = '';
...
function drawLines(array) {
	...
	// move to the first point in bestPath
